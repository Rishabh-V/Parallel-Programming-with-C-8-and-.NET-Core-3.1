...
{
    /// <summary>
    /// This program demonstrates how exception handling can be done in multithreaded program.
    /// </summary>
    class Program
    {
        ...
        static void WriteToConsole()
        {
            ...
            {
                Console.WriteLine($"Exception occurred {ex.Message}. Stack trace - {ex.StackTrace}");
            }
        }
    }
}
